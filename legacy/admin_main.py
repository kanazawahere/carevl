...
from ui.admin_app import main as launch_admin_app
...
def setup_logging():
    ...
    LOG_FILE = os.path.join(log_dir, "carevl-admin.log")
...
def handle_exception(exc_type, exc_value, exc_traceback):
    ...
    logging.error("Unhandled admin exception", exc_info=(exc_type, exc_value, exc_traceback))
    ...
    try:
        ...
        ctk.CTkLabel(
            dialog,
            text=f"Đã xảy ra lỗi không mong muốn trong Admin App:\n\n{str(exc_value)}",
...
if __name__ == "__main__":
    ...
    logging.info("Starting CareVL Admin Application")
    try:
        launch_admin_app()
    except Exception:
